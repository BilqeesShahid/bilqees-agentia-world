      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {agents.map((agent) => (
            <Card
              key={agent.name}
              className="bg-gray-900 border-purple-700 hover:border-cyan-500 transition-colors"
            >
              <CardHeader>
              ...
              <CardContent className="text-purple-200">
                Advanced AI agent specialized in {agent.name.toLowerCase()}, providing cutting-edge solutions for your business needs.
              </CardContent>
            </Card>
          ))}
        </div>
